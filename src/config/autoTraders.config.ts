export const AutoTraders_SELECTORS = {
    ...
    PRICE: 'div[class=numberplate-cont] > div[class=user-det]> ul > li:nth-child(1) > h3',
    ...
    CONFIG: {
      HEADERS: {
        ...
        cookie: 'ci_session=p99v4en1bd67dajh39fg4eh61b1vimjo; ci_session=2d7ak9vru7edg5n64q4ko5aliig0tess',
        priority: 'u=0, i',
