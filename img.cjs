...
let config = {
  ...
  responseType: 'stream' // Important to handle image data
};

axios.request(config)
  .then((response) => {
    // Path to save the image
    const imagePath = path.resolve(__dirname, 'images', '55451.png');
